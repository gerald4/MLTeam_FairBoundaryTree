...
def generate_synthetic_data(plot_data=False):
    ...
    n_samples = 1500 # generate these many data points per class
    disc_factor = math.pi / 4. # this variable determines the initial discrimination in the data -- decraese it to generate more discrimination
